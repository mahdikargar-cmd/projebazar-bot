...
const contactHandler = async (ctx) => {
    ...
    if (!contact) {
        ...
        ctx.reply('⚠️ لطفاً فقط از دکمه "📱 ارسال شماره تلفن" استفاده کنید. شماره را به‌صورت دستی وارد نکنید.');
        return;
    }
    ...
    if (!normalizedPhone) {
        ...
        ctx.reply('⚠️ شماره تلفن معتبر نیست. لطفاً یک شماره معتبر (مثل 09123456789 یا +989123456789) وارد کنید.');
        return;
    }
    try {
        ...
        if (!phoneExists) {
            ...
            ctx.reply('✅ شماره تلفن شما با موفقیت ثبت شد! حالا می‌توانید نوع آگهی را انتخاب کنید:', {
                reply_markup: {
            ...
            ctx.reply('✅ شماره تلفن شما قبلاً ثبت شده است. لطفاً نوع آگهی را انتخاب کنید:', {
                reply_markup: {
                    remove_keyboard: true,
                },
            });
